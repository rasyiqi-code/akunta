...
export const WarRoom: React.FC = () => {
  ...
  return (
    <div style={{ padding: '20px', overflowY: 'auto', flex: 1, display: 'flex', flexDirection: 'column', gap: '20px' }}>
      ...
      {/* Sapaan Personal */}
      <div>
        <h2 style={{ fontFamily: 'var(--font-display)', fontWeight: 600, fontSize: '20px', marginBottom: '4px' }}>
          War Room Akunta
        </h2>
      ...
      <div className="financial-card-grid">
        {/* Kas/Bank */}
        <div className="financial-summary-card" style={{ borderLeft: '3px solid var(--accent-primary)' }}>
          <span className="card-label" style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
            <Wallet size={14} /> Total Saldo Kas/Bank
          </span>
        ...
        {/* Laba/Rugi */}
        <div className="financial-summary-card" style={{ borderLeft: `3px solid ${netProfit >= 0 ? 'var(--accent-success)' : 'var(--accent-danger)'}` }}>
          <span className="card-label" style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
            <TrendingUp size={14} /> Laba Bersih Bulan Ini
          </span>
        ...
        {/* Uang Masuk Hari Ini */}
        <div className="financial-summary-card" style={{ borderLeft: '3px solid var(--accent-success)' }}>
          <span className="card-label">Uang Masuk Hari Ini</span>
          <div className="card-value" style={{ fontSize: '20px', color: 'var(--accent-success)' }}>
            +Rp {cashInToday.toLocaleString('id-ID')}
          </div>
        </div>

        {/* Uang Keluar Hari Ini */}
        <div className="financial-summary-card" style={{ borderLeft: '3px solid var(--accent-danger)' }}>
          <span className="card-label">Uang Keluar Hari Ini</span>
          <div className="card-value" style={{ fontSize: '20px', color: 'var(--accent-danger)' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
        <h3 style={{ fontFamily: 'var(--font-display)', fontSize: '14px', fontWeight: 600, display: 'flex', alignItems: 'center', gap: '6px', color: 'var(--text-secondary)' }}>
          <BellRing size={14} />
          <span>Notifikasi Prioritas AI</span>
        </h3>
      ...
      {/* Panduan Input Cepat */}
      <div style={{ background: 'rgba(255,255,255,0.02)', padding: '16px', borderRadius: 'var(--radius-md)', border: '1px solid var(--border-color)', marginTop: 'auto' }}>
        <h4 style={{ fontFamily: 'var(--font-display)', fontSize: '13px', fontWeight: 600, marginBottom: '8px', color: 'var(--text-primary)' }}>
        ...
        <ul style={{ fontSize: '11px', color: 'var(--text-secondary)', paddingLeft: '16px', lineHeight: '1.6' }}>
          ...
          <li>"Beli bahan kopi 1.2jt ngutang dulu"</li>
          <li>"Bayar gaji karyawan 4jt pake Bank BCA"</li>
          <li>"Tampilkan laporan laba rugi"</li>
        </ul>
      </div>
