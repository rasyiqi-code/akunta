...
import { 
  ShoppingBag, Plus, CheckCircle, AlertTriangle, 
  ...
  return (
    <div style={{ padding: '16px', display: 'flex', flexDirection: 'column', gap: '16px', color: '#f3f4f6' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '16px' }}>
        <div className="card-custom" style={{ padding: '16px', background: 'rgba(239, 68, 68, 0.1)', border: '1px solid rgba(239, 68, 68, 0.2)', borderRadius: '8px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
            <span style={{ fontSize: '11px', color: '#fca5a5', textTransform: 'uppercase' }}>Belanja Bulan Ini</span>
            <ShoppingBag size={14} style={{ color: '#fca5a5' }} />
          </div>
          <h3 style={{ margin: 0, fontSize: '16px', fontWeight: '600' }}>
            Rp {totalSpent.toLocaleString('id-ID')}
          </h3>
          <span style={{ fontSize: '10px', color: '#9ca3af' }}>Nilai transaksi pembelian final</span>
        </div>

        <div className="card-custom" style={{ padding: '16px', background: 'rgba(245, 158, 11, 0.1)', border: '1px solid rgba(245, 158, 11, 0.2)', borderRadius: '8px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
            <span style={{ fontSize: '11px', color: '#fde047', textTransform: 'uppercase' }}>Perintah Bayar Pending</span>
            <Landmark size={14} style={{ color: '#fde047' }} />
          </div>
          <h3 style={{ margin: 0, fontSize: '16px', fontWeight: '600' }}>
            Rp {pendingPayments.toLocaleString('id-ID')}
          </h3>
          <span style={{ fontSize: '10px', color: '#9ca3af' }}>Tagihan terverifikasi belum dibayar</span>
        </div>

        <div className="card-custom" style={{ padding: '16px', background: 'rgba(59, 130, 246, 0.1)', border: '1px solid rgba(59, 130, 246, 0.2)', borderRadius: '8px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
            <span style={{ fontSize: '11px', color: '#93c5fd', textTransform: 'uppercase' }}>Supplier / Vendor</span>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '12px' }}>
            <thead>
              <tr style={{ background: 'rgba(255,255,255,0.02)', textAlign: 'left', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
                <th style={{ padding: '10px 16px' }}>ID Vendor</th>
                <th style={{ padding: '10px 16px' }}>Nama Pemasok</th>
              ...
              {contacts.map(c => (
                <tr key={c.id} style={{ borderBottom: '1px solid rgba(255,255,255,0.02)' }}>
                  ...
                  <td style={{ padding: '10px 16px' }}>
                    <span style={{ padding: '2px 6px', background: 'rgba(239, 68, 68, 0.1)', color: '#fca5a5', borderRadius: '4px', fontSize: '10px' }}>
                      {c.type}
                    </span>
                  </td>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '12px' }}>
            <thead>
              <tr style={{ background: 'rgba(255,255,255,0.02)', textAlign: 'left', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
                ...
                <th style={{ padding: '10px 16px' }}>Pemasok</th>
                <th style={{ padding: '10px 16px' }}>Tipe</th>
                ...
                getFilteredDocs().map(doc => {
                  ...
                  return (
                    <tr key={doc.id} style={{ borderBottom: '1px solid rgba(255,255,255,0.02)' }}>
                      ...
                      <td style={{ padding: '10px 16px' }}>{supplier}</td>
                      <td style={{ padding: '10px 16px' }}>
                        <span style={{ 
                          padding: '2px 6px', 
      ...
      {showModal && (
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid rgba(255,255,255,0.05)', paddingBottom: '8px' }}>
              <h3 style={{ margin: 0, fontSize: '14px', fontWeight: '600' }}>Buat Dokumen Pembelian Baru</h3>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '12px', overflowY: 'auto', maxHeight: '60vh', paddingRight: '4px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
                ...
                <div>
                  <label style={{ display: 'block', fontSize: '11px', color: '#9ca3af', marginBottom: '4px' }}>Pemasok / Supplier</label>
                  <select 
                    value={contactId} 
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
                <div>
                  <label style={{ display: 'block', fontSize: '11px', color: '#9ca3af', marginBottom: '4px' }}>Referensi No. PO / Penerimaan</label>
                  <input 
                    type="text" 
                ...
                <div>
                  <label style={{ display: 'block', fontSize: '11px', color: '#9ca3af', marginBottom: '4px' }}>Bayar Uang Muka (DP)</label>
                  <input 
                    type="number" 
                    value={dpApplied}
              ...
              <div>
                <label style={{ display: 'block', fontSize: '11px', color: '#9ca3af', marginBottom: '4px' }}>Daftar Barang</label>
